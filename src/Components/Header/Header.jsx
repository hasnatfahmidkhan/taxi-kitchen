...
const Header = ({ mainSectionRef }) => {
  ...
  return (
    <header className="flex flex-col gap-5 justify-center items-center min-h-screen">
      ...
      <div
        onClick={handleScroolToMain}
        className="w-20 h-20 flex items-center justify-center animate-bounce bg-[#FEBF00] mt-10 rounded-full shadow-xl justify-self-end cursor-pointer"
      >
